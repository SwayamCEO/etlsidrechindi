...
function SectionTwo() {
    ...
    return (
        <div id="sectionTwoId" className="question">
            ...
            <p>2.Social Awarness</p>
            <Question questionText="A) Gain knowledge about Self & Family" name="q4" onRadioChange={(score) => handleSectionTwoRadioChange(0, score)} />
            <Question questionText="B) Gain knowledge about immediate Environment- Places & People (School, Public Places, Market, etc)" name="q5" onRadioChange={(score) => handleSectionTwoRadioChange(1, score)} />
            <Question questionText="C) Gain knowledge about Activities/Work" name="q6" onRadioChange={(score) => handleSectionTwoRadioChange(2, score)} />
            <Question questionText="D) Practice norms of work place" name="q7" onRadioChange={(score) => handleSectionTwoRadioChange(3, score)} />
            <Question questionText="E) Gain knowledge about Services/ Facilities available" name="q8" onRadioChange={(score) => handleSectionTwoRadioChange(4, score)} />
            <Question questionText="F) Gain knowledge about maintaining good health" name="q9" onRadioChange={(score) => handleSectionTwoRadioChange(5, score)} />
            <Question questionText="G) Gain knowledge about advocacy" name="q10" onRadioChange={(score) => handleSectionTwoRadioChange(6, score)} />
            <Question questionText="H) Gain knowledge about salary/ honorarium" name="q11" onRadioChange={(score) => handleSectionTwoRadioChange(7, score)} />
            <Question questionText="I) Gain knowledge about familiar emergency procedure" name="q12" onRadioChange={(score) => handleSectionTwoRadioChange(8, score)} />
            <br />
            <br />
            <center>
