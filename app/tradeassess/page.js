...
export default function Home() {
  ...
  const printValues = () => {
      ...
      const gp = ((grand1 / 120) * 100).toFixed(2);
      const gp1 = ((grand2 / 280) * 100).toFixed(2);
                ...
                <center>
                  <table border={1} cellSpacing={0}>
                   ...
                   <Ttitle/>
                    ...
                    <PrintingRow criteria="2.छवि को पारदर्शी कागज में स्थानांतरित करना।" totalMark={13} marksCount={4} marks1Count={9} no={2} setSums={setSums}/>
                    ...
                    <PrintingRow criteria="5.पुरस्कारों के लिए ग्राफिक छवि बनाना।" totalMark={20} marksCount={6} marks1Count={14} no={4} setSums={setSums} />
                    <TotalRow outOf={100} totalMarks={100} ti={4} sums={sums} theory={30} practical={70}/>
                    <PrintingTableRow outcome="5.रंगों को ठीक करना और छवियों पर रंगों का प्रबंधन करना" crieteria="1.किसी भी प्रचारात्मक उत्पाद पर रंगों को ठीक करना और रंगों का प्रबंधन करना" outof={100} totalMarks={20} rowspan={5} marksCount={6} marks1Count={14} no={5} setSums={setSums} />
                    <PrintingRow criteria="2.किसी भी खेल आइटम पर रंगों को ठीक करना और रंगों का प्रबंधन करना" totalMark={20} marksCount={6} marks1Count={14} no={5} setSums={setSums}/>
                    <PrintingRow criteria="3.किसी भी साइनेज आइटम पर रंगों को ठीक करना और रंगों का प्रबंधन करना " totalMark={20} marksCount={6} marks1Count={14} no={5} setSums={setSums}/>
                    <PrintingRow criteria="4.रंगों को ठीक करना और किसी भी वस्त्र पर रंगों का प्रबंधन करना" totalMark={20} marksCount={6} marks1Count={14} no={5} setSums={setSums}/>
                    <PrintingRow criteria="5.रंगों को ठीक करना और किसी भी पुरस्कार पर रंगों का प्रबंधन करना" totalMark={20} marksCount={6} marks1Count={14} no={5} setSums={setSums}/>
                    <TotalRow outOf={100} totalMarks={100} ti={5} sums={sums} theory={30} practical={70}/>
